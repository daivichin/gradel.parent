package com.gradel.parent.common.rocketmq.base;

import com.google.gson.JsonSyntaxException;
import com.gradel.parent.common.rocketmq.util.JsonUtil;
...
public abstract class AbstractMQConsumer<T> {
    ...
    protected T parseMessage(MessageExt message) {
        ...
        if (type instanceof Class) {
            try {
                T data = JsonUtil.fromJson(new String(message.getBody()), (Class<T>) type);
                return data;
