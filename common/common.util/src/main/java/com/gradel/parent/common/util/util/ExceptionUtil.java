...
import com.gradel.parent.common.util.api.annotation.Nullable;
import com.gradel.parent.common.util.exception.DataBaseOperateException;
import com.gradel.parent.common.util.exception.RemoteAccessException;
import com.gradel.parent.common.util.exception.RemoteAccessTimeOutException;
...
public abstract class ExceptionUtil {
    ...
    public static DataBaseOperateException translateDataBaseException() {
        return new DataBaseOperateException();
    }
    ...
    public static void throwRemoteAccessException(Throwable e) throws SystemException {
        while (e != null) {
            if (e instanceof SocketTimeoutException) {
                throw new RemoteAccessTimeOutException();
            }
     ...
     * <p>
     * <pre>
     * private static RuntimeException TIMEOUT_EXCEPTION = exception.ExceptionUtil.setStackTrace(new RuntimeException("Timeout"),
