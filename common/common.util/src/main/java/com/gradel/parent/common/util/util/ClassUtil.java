...
import com.gradel.parent.common.util.exception.InstantiationObjectException;
import com.gradel.parent.common.util.exception.UnknownClassException;
...
public class ClassUtil {
    ...
    public static Object newInstance(Class clazz) {
        ...
        try {
            ...
            throw new InstantiationObjectException("Unable to instantiate class [" + clazz.getName() + "]", e);
        }
    }
