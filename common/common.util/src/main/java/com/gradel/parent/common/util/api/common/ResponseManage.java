...
import com.gradel.parent.common.util.api.response.EmptyResponse;
 ...
 * Date 2017/3/14
 */
public abstract class ResponseManage {

    public static EmptyResponse emptyResponse = new EmptyResponse();
     ...
     *
     */
    public static CommonResponse<EmptyResponse> successEmpty() {
        CommonResponse response = new CommonResponse();
        response.setResult(EmptyResponse.empty());
     ...
     */
    @Deprecated
    public static CommonResponse<EmptyResponse> success() {
        CommonResponse response = new CommonResponse();
