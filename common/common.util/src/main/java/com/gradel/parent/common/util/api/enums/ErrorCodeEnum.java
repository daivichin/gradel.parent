...
public enum ErrorCodeEnum implements CommonError {
    ...
    USER_INFO_UN_KNOWN_ERROR(1016, "帐号不存在"),

    USER_LOGIN_UN_KNOWN_ERROR(1017, "帐号登录信息不存在"),
     ...
     * 限流
     */
    FLOW_BLOCK_EXCEPTION(6000, "服务器繁忙，请稍后重试"),

    /**
     * 降级
     */
    DEGRADE_BLOCK_EXCEPTION(6001, "服务器繁忙，请稍后重试"),

    ORDER_LIST_EXCEPTION(8001, "跳转都订单列表"),
    CANCEL_ORDER(8002, "订单已取消"),
