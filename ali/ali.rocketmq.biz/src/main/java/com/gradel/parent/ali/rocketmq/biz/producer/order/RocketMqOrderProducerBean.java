package com.gradel.parent.ali.rocketmq.biz.producer.order;

import com.aliyun.openservices.ons.api.ONSFactory;
import com.aliyun.openservices.ons.api.exception.ONSClientException;
import com.aliyun.openservices.ons.api.order.OrderProducer;
import com.gradel.parent.ali.rocketmq.biz.model.MqMessageBody;
import com.gradel.parent.ali.rocketmq.biz.model.order.RockMqOrderMessage;
import com.gradel.parent.ali.rocketmq.biz.producer.order.api.RocketMqOrderProducer;
...
//                objectStr = JacksonUtil.toJson(object);
            ...
            Object[] params = {SerialNo.getSerialNo(), message.getTopic(), message.getTag(), message.getKey(), objectStr, message.getShardingKey(), (System.currentTimeMillis() - start), ExceptionUtil.getAsString(e)};
