package com.gradel.parent.ali.rocketmq.biz.producer;

import com.aliyun.openservices.ons.api.ONSFactory;
import com.aliyun.openservices.ons.api.Producer;
import com.aliyun.openservices.ons.api.SendCallback;
import com.aliyun.openservices.ons.api.exception.ONSClientException;
import com.gradel.parent.ali.rocketmq.biz.producer.api.RocketMqProducer;
import com.gradel.parent.ali.rocketmq.biz.model.RockMqMessage;
...
public class RocketMqProducerBean implements RocketMqProducer {
    ...
    public boolean send(final RockMqMessage message){
        ...
        try {
            ...
            Object[] params = {SerialNo.getSerialNo(), message.getTopic(), message.getTag(), message.getKey(), objectStr, (System.currentTimeMillis() - start), ExceptionUtil.getAsString(e)};
