...
public class RockMqMessage<T> extends com.aliyun.openservices.ons.api.Message implements Serializable {
    ...
    public RockMqMessage(MqTopic topic, MqBaseMessageBody<T> content) {
        ...
        super(topic.getCode(), topic.getTag(), content.getBusinessId(), null/*SerializerUtil.serialize(body)*/);
