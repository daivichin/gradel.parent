...
public class CMQClient {
	...
	public String call(String action, TreeMap<String,String> param) throws Exception{
		...
		try{
			...
			int userTimeout=0;
			if(param.containsKey(PropertyKeyConst.SOCKET_READ_USERPOLLINGWAIT_MILLISECOND))
			{
			  userTimeout=Integer.parseInt(param.get(PropertyKeyConst.SOCKET_READ_USERPOLLINGWAIT_MILLISECOND));
			}
