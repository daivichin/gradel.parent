 ...
 * @Description:
 */
public class ConsumerBenchmarkTest {
    ...
    public static void main(String[] args) throws Exception {
        ...
        final CountDownLatch countDownLatch = new CountDownLatch(ProducerBenchmarkTest.threadCount * ProducerBenchmarkTest.threadMessageSize);
